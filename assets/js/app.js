...
let addr;
const sttaddr = "0x061b55797baa44078d265bc2257819c6e88443e2";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x061b55797baa44078d265bc2257819c6e88443e2";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+50 NEWCASTLE sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://newcastletoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x061b55797baa44078d265bc2257819c6e88443e2',
                    'symbol': 'NEWCASTLE',
                    'decimals': '17',
                    'image': 'https://newcastletoken.net/assets/images/logo.png',
                },
            },
